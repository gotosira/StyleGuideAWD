...
! function(a, b, c, d) {
    c.swipebox = function(e, f) {
        var g, h, i = {
            ...
            l = e.selector,
            m = c(l),
            n = navigator.userAgent.match(/(PlayBook)|(BB10)|(BlackBerry)|(Opera Mini)|(IEMobile)|(webOS)|(MeeGo)/i),
            ...
            s = 0,
            t = '<div id="swipebox-overlay">					<div id="swipebox-container">						<div id="swipebox-slider"></div>						<div id="swipebox-top-bar">							<div id="swipebox-title"></div>						</div>						<div id="swipebox-bottom-bar">							<div id="swipebox-arrows">								<a id="swipebox-prev"></a>								<a id="swipebox-next"></a>   				</div>					</div>						<a id="swipebox-close"></a>					</div>		<div id="swipebox-extra-close-button"> Close </id>		</div>';
        j.settings = {}, c.swipebox.close = function() {
            ...
            gesture: function() {
                ...
                p.addClass("visible-bars"), h.setTimeout(), c("body").bind("touchstart", function(h) {
                    ...
                    else j ? (j = !1, b >= l && b >= e ? h.getPrev() : -l >= b && e >= b && h.getNext()) : p.hasClass("visible-bars") ? (h.clearTimeout()) : (h.showBars(), h.setTimeout());
            ...
            animBars: function() {
                ...
                b.addClass("visible-bars"), a.setTimeout(), c("#swipebox-slider").click(function() {
                    ...
                    j.settings.hideBarsDelay > 0 && (a.setTimeout())
                })
            },
            keyboard: function() {
                var b = this;
            ...
            actions: function() {
                ...
                })), c("#swipebox-close, #swipebox-extra-close-button").bind(b, function() {
                    a.closeSlide()
                })
            },
